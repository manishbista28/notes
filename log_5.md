...
it's an enzyme that hydrolyzes asparagine which cancer needs

body's defenses can neutralize the enzyme -- seen in 1 to 4 percent of patients
this is especially true post induction where you give L-Asp again; body could have prepared antibodies by then

body's antidrug antibodies act against enzyme
they do so by triggering an immune response like histamine release
body exhibits response similar to an infection - rashes, fever, etc
it can become difficult to distinguish between this hypersensitivity and symptoms of neutropenic sepsis

L-Asp is toxic
pre-medicate to reduce anti-inflammation
glucocortoids and corticosteroids can have interactions
make note of liver, pancreas health, glucose levels, thrombocytosis, etc
